                ...
                <section class="relative">
                  <div class="py-2 bg-blue-500">
                    <div class="flex items-center justify-center">
                      ...
                      <p class="text-xs font-bold font-heading text-blue-50">BlackFriday 20% OFF en compras mayores a $3000</p>
                    </div>
                  </div>
                  <nav class="relative flex flex-wrap">
                    <div class="flex justify-between w-full bg-blue-300">
                      ...
                      <div class="px-12 py-8 flex w-full items-center">
                        <a class="flex-shrink-0 text-3xl font-bold font-heading text-white" href="#">
                          <img class="h-9" src="https://static.shuffle.dev/uploads/files/2b/2bd2840ec25689dd16105d216b08b5a2929c3dfd/yofte-logo-white.png" alt="" width="auto" />
                        </a>
                        <ul class="hidden lg:flex absolute top-10 left-1/2 transform -translate-y-1/2 -translate-x-1/2 mt-2 lg:items-center lg:w-auto">
                          <li><a class="inline-block w-28 mr-3 py-2 text-center hover:text-white bg-white hover:bg-gray-900 rounded-full font-bold font-heading transition duration-200" href="#">Nuevos</a></li>
                          <li><a class="inline-block w-28 mr-3 py-2 text-center hover:text-white bg-white hover:bg-gray-900 rounded-full font-bold font-heading transition duration-200" href="#">Nike</a></li>
                          <li><a class="inline-block w-28 mr-3 py-2 text-center hover:text-white bg-white hover:bg-gray-900 rounded-full font-bold font-heading transition duration-200" href="#">Adidas</a></li>
                          <li><a class="inline-block w-28 mr-3 py-2 text-center hover:text-white bg-white hover:bg-gray-900 rounded-full font-bold font-heading transition duration-200" href="#">Puma</a></li>
                          <li><a class="inline-block w-28 mr-3 py-2 text-center hover:text-white bg-white hover:bg-gray-900 rounded-full font-bold font-heading transition duration-200" href="#">Kappa</a></li>
                        </ul>
                      </div>
                  ...
                  <div class="hidden navbar-menu fixed top-0 left-0 bottom-0 w-5/6 max-w-sm z-50">
                    ...
                    <nav class="relative flex flex-col py-6 px-6 w-full h-full bg-white border-r overflow-y-auto">
                      ...
                      <input class="block mb-10 py-5 px-8 bg-gray-100 rounded-md border-transparent focus:ring-blue-300 focus:border-blue-300 focus:outline-none" type="search" placeholder="Search"></input>
                      <ul class="text-3xl font-bold font-heading">
                        <li class="mb-8"><a href="#">Nike</a></li>
                        <li class="mb-8"><a href="#">Adidas</a></li>
                        <li class="mb-8"><a href="#">Kappa</a></li>
                        <li class="mb-8"><a href="#">Puma</a></li>
