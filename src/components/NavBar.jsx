...
import BlackFriday from './ItemListContainer';
...
<section className="relative">
                  ...
                  <nav className="relative flex flex-wrap">
                    <div className="flex justify-between w-full bg-blue-300">
                      ...
                      <div className="px-12 py-8 flex w-full items-center">
                        <a className="flex-shrink-0 text-3xl font-bold font-heading text-white" href="#">
                          <img className="h-9" src="https://static.shuffle.dev/uploads/files/2b/2bd2840ec25689dd16105d216b08b5a2929c3dfd/yofte-logo-white.png" alt="" width="auto" />
                        </a>
                        <ul className="hidden lg:flex absolute top-10 left-1/2 transform -translate-y-1/2 -translate-x-1/2 mt-2 lg:items-center lg:w-auto">
                          <li><a className="inline-block w-28 mr-3 py-2 text-center hover:text-white bg-white hover:bg-gray-900 rounded-full font-bold font-heading transition duration-200" href="#">Nuevos</a></li>
                          <li><a className="inline-block w-28 mr-3 py-2 text-center hover:text-white bg-white hover:bg-gray-900 rounded-full font-bold font-heading transition duration-200" href="#">Nike</a></li>
                          <li><a className="inline-block w-28 mr-3 py-2 text-center hover:text-white bg-white hover:bg-gray-900 rounded-full font-bold font-heading transition duration-200" href="#">Adidas</a></li>
                          <li><a className="inline-block w-28 mr-3 py-2 text-center hover:text-white bg-white hover:bg-gray-900 rounded-full font-bold font-heading transition duration-200" href="#">Puma</a></li>
                          <li><a className="inline-block w-28 mr-3 py-2 text-center hover:text-white bg-white hover:bg-gray-900 rounded-full font-bold font-heading transition duration-200" href="#">Kappa</a></li>
                        </ul>
                      </div>
                      ...
                      <a className="hidden xl:flex items-center px-12 border-l border-blue-200 font-semibold font-heading text-white" href="#">
                      ...
                      <a className="xl:hidden flex mr-6 items-center text-white" href="#">
                        ...
                        <span className="inline-block w-6 h-6 text-center text-gray-900 bg-white rounded-full font-semibold font-heading">3</span>
                      </a>
                  ...
                  <div className="hidden navbar-menu fixed top-0 left-0 bottom-0 w-5/6 max-w-sm z-50">
                    ...
                    <nav className="relative flex flex-col py-6 px-6 w-full h-full bg-white border-r overflow-y-auto">
                      ...
                      <input className="block mb-10 py-5 px-8 bg-gray-100 rounded-md border-transparent focus:ring-blue-300 focus:border-blue-300 focus:outline-none" type="search" placeholder="Search"></input>
                      <ul className="text-3xl font-bold font-heading">
                        <li className="mb-8"><a href="#">Nike</a></li>
                        <li className="mb-8"><a href="#">Adidas</a></li>
                        <li className="mb-8"><a href="#">Kappa</a></li>
                        <li className="mb-8"><a href="#">Puma</a></li>
